...
* **achsensymmetrisch zur $y$-Achse (gerade Funktion)**
    <img src="Bilder/graph_22.svg" style="width: 65%;">
    |$$ f(x) = f(-x) $$|
    |-|
* **punktsymmetrisch zum Koordinatenursprung (ungerade Funktion)**
    <img src="Bilder/graph_23.svg" style="width: 65%;">
    |$$ f(x) = -f(-x) $$|
    |-|
...
$f(x):$<img src="Bilder/graph_24.svg" style="width: 20%;">

$f'(x):$<img src="Bilder/graph_25.svg" style="width: 20%;">

$f''(x):$<img src="Bilder/graph_26.svg" style="width: 20%;">
